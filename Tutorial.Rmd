...
Für die Berechnung brauchst du die **Mittelwerte** die **Standardabweichungen** die **Kovarianz** und die **Korrelation** beider Merkmale. 

### Kovarianz
Die **Kovarianz** gibt an, in wiefern zwei Merkmale zusammenhängen, genauer, ob eine Variable ausschlaggebend für die Zu-oder abnahme einer anderen Variablen ist. Man kann die Kovarianz also nutzen um lineare Beziehungen zu prüfen.
...
Im Anschluss können wir dann beide Geraden vergleichen.
